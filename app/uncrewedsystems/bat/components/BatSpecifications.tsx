...
export default function BatSpecifications(): React.JSX.Element {
  // The features array has been updated with the content from your image.
  const features: FeatureProps[] = [
    {
      title: "Multi-Role Capability",
      description:
        "One platform, many possibilities – modular payload integration empowers rapid role changes without any downtime.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Intelligent algorithms scan the environment, identify key objects, providing mission teams with clear, actionable data.",
    },
    {
      title: "Target Acquisition and Recon",
      description:
        "Detect, identify, and track with precision — delivering actionable intelligence and live situational awareness where it matters most.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Engineered for near-silent performance to stay discreet, minimize noise, and avoid detection during critical missions.",
    },
  ]
