...
class InfiniteGridMenu {
    ...
    private init(onInit?: InitCallback): void {
        ...
        vec2.copy(this.drawBufferSize, vec2.create()); // Dummy size init
...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [], scale = 1.0 }) => {
    ...
    useEffect(() => {
        ...
        if (canvas) {
            sketch = new InfiniteGridMenu(
                canvas,
                items.length ? items : [{ image: 'https://picsum.photos/900/900?grayscale', link: '#', title: '', description: '' }],
                handleActiveItem,
                setIsMoving,
                sk => sk.run(),
                scale
    ...
    return (
        <div className="relative w-full h-[600px] md:h-[800px] bg-white overflow-hidden">
            <canvas id="infinite-grid-menu-canvas" ref={canvasRef} />

            {/* UI Overlays removed for image-only gallery view */}
        ...
        @media (max-width: 1024px) {
          .face-title { font-size: 2.5rem; }
          .face-description { display: none; }
        }
      `}</style>
        </div>
    );
...
const CulturePage = () => {
    ...
    const menuItems: MenuItem[] = [
        { title: "", description: "", image: "/images/culture/culture1.webp", link: "#" },
        { title: "", description: "", image: "/images/culture/culture2.jpg", link: "#" },
        { title: "", description: "", image: "/images/culture/culture3.jpg", link: "#" },
        { title: "", description: "", image: "/images/culture/culture4.jpg", link: "#" },
        { title: "", description: "", image: "/images/culture/culture5.jpg", link: "#" },
        { title: "", description: "", image: "/images/culture/culture6.webp", link: "#" },
        { title: "", description: "", image: "/images/culture/culture7.png", link: "#" },
        { title: "", description: "", image: "/images/culture/culture8.webp", link: "#" },
        { title: "", description: "", image: "/images/culture/culture9.webp", link: "#" },
        { title: "", description: "", image: "/images/culture/culture10.jpg", link: "#" }
    ];

    return (
        <div className="bg-white min-h-screen text-black font-clash overflow-hidden">
            {/* Hero Section - Redesigned to match minimalist tech aesthetic in light mode */}
            <section className="relative pt-32 pb-24 px-6 md:px-20 overflow-hidden bg-white">
                <div className="max-w-[1400px] mx-auto">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-[#5ce1e6] font-medium text-xs md:text-sm tracking-[0.2em] uppercase">
                                [ Inside Tsalla ]
                            </span>
                        </div>
                        ...
                        <div className="flex flex-col gap-10">
                            <div className="max-w-5xl">
                                <h1
                                    className="text-4xl md:text-[5.5rem] font-bold tracking-normal leading-[1.1] mb-10 text-black uppercase italic"
                                    style={{ wordSpacing: '0.1em' }}
                                >
                                    A Culture of <br />
                                    <span className="text-black/80">Defiant Innovation</span>
                                </h1>
                                <p className="text-black/60 text-xl md:text-2xl max-w-2xl font-light leading-relaxed tracking-normal">
                                    We don&apos;t just build tech; we build the future of autonomy. Our culture is defined by those who refuse to accept common limits.
                                </p>
                            </div>
                        </div>
                        ...
                        <motion.div
                            ...
                            className="mt-20 relative w-full aspect-[21/9] overflow-hidden bg-zinc-900 group"
                        >
                            <img
                                ...
                                alt="Aerospace Cockpit Mission"
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-60" />

                            {/* Scanning line effect */}
                            <div className="absolute top-0 left-0 w-full h-[1px] bg-[#5ce1e6]/30 shadow-[0_0_15px_rgba(92,225,230,0.5)] animate-scan pointer-events-none" />
                        </motion.div>
                    </motion.div>
                </div>
            ...
            {/* Philosophy Section */}
            <section className="py-24 px-6 relative z-10 bg-black text-white">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2
                                className="text-3xl md:text-5xl font-bold mb-8 uppercase tracking-normal text-white"
                                style={{ wordSpacing: '0.15em' }}
                            >
                                The Frontline Mindset
                            </h2>
                            <div className="space-y-6 text-zinc-400 font-clash text-lg leading-relaxed tracking-[0.02em]">
                                <p>
                                    At Tsalla Aerospace, we operate with the urgency of the missions we support. Our team is a strike group of engineers, designers, and strategists who thrive in high-stakes environments.
                                </p>
                                <p>
                                    We believe that small, elite teams can out-innovate massive bureaucracies. We prioritize speed, autonomy, and the courage to challenge legacy thinking.
                                </p>
                            </div>
                        </div>
                        <div className="relative">
                            <div className="absolute inset-0 bg-[#5ce1e6]/20 blur-3xl rounded-full scale-75" />
                            <img
                                src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=800"
                                alt="Tsalla Team Work"
            ...
            {/* NEW Infinite Menu Section - White Background */}
            <section className="pt-20 pb-32 bg-white relative">
                <div className="max-w-7xl mx-auto px-6">
                    <h3
                        className="text-4xl md:text-6xl font-black italic uppercase tracking-normal text-black"
                        style={{ wordSpacing: '0.1em' }}
                    >
                        Life at Tsalla
                    </h3>
                ...
                <div className="mt-10 max-w-[1600px] mx-auto px-6">
                    <div className="relative border border-black/10 rounded-[2rem] overflow-hidden bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
