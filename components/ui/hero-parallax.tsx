...
export const HeroParallax = ({
    ...
    const translateY = useSpring(
        useTransform(scrollYProgress, [0, 0.2], [-450, 200]),
        springConfig
    );
    return (
        <div
            ref={ref}
            className="h-[225vh] pt-20 pb-10 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
        >
...
export const Header = ({
    ...
    return (
        <div className="max-w-7xl relative mx-auto pt-10 md:pt-20 pb-20 md:pb-40 px-4 w-full  left-0 top-0">
            <h1 className="text-2xl md:text-7xl font-bold text-black dark:text-white font-clash">
                {title || "The Ultimate development studio"}
            </h1>
            <p className="max-w-2xl text-base md:text-xl mt-8 text-neutral-700 dark:text-neutral-200 font-clash">
